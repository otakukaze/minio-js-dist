...
export declare function requestWithRetry(transport: Transport, opt: https.RequestOptions, body?: Buffer | string | stream.Readable | null, maxRetries?: number, baseDelayMs?: number, maximumDelayMs?: number, log?: (msg: string) => void): Promise<http.IncomingMessage>;